...
; Case ID: case_0
; Generated at: 2025-10-20T21:37:54.703148
;
...
(assert (let ((a!1 (or (not (<= (/ 1.0 2.0) (/ own_capital risk_capital)))
      ...
      (a!5 (and (<= (/ 3.0 2.0) (/ own_capital risk_capital))
                (not (<= 2.0 (/ own_capital risk_capital)))))
      (a!6 (and (<= 2.0 (/ own_capital risk_capital))
                (<= (/ 3.0 100.0)
                    (ite (>= net_worth_prev net_worth) net_worth_prev net_worth)))))
(let ((a!4 (and a!3
                (<= 0.0
                    (ite (<= net_worth_prev net_worth) net_worth_prev net_worth)))))
(let ((a!7 (ite a!1 4 (ite (or a!2 a!4) 3 (ite a!5 2 (ite a!6 1 0))))))
  (= capital_level a!7)))))
...
(assert (= net_worth_prev (/ 297.0 100.0)))
(assert (= capital_insufficient_plan_submitted true))
(assert (= capital_insufficient_plan_executed false))
(assert (= capital_significantly_insufficient_additional_measures_executed false))
(assert (= capital_severely_insufficient_additional_measures_executed false))
