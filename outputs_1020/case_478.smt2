...
; Case ID: case_478
; Generated at: 2025-10-19T16:54:54.466231
;
...
(declare-const compliance_internal_systems Bool)
...
; [bank:compliance_internal_systems] 銀行內部制度建立且確實執行
(assert (= compliance_internal_systems
   (and internal_control_ok internal_handling_ok internal_operation_ok)))

; [bank:violation_129_7] 違反第129條第7款規定：未依規定建立或執行內部控制、處理、作業制度
(assert (not (= compliance_internal_systems violation_129_7)))
...
(assert (= compliance_internal_systems false))
