...
; Case ID: case_130
; Generated at: 2025-10-19T08:46:20.287181
;
...
; [meta:penalty_conditions] 處罰條件：未建立或未確實執行內部控制、稽核制度或招攬處理制度時處罰
(assert (= penalty
   (or (not audit_system_compliance)
       (not solicitation_handling_compliance)
...
(assert (= solicitation_handling_compliance false))
