...
; Case ID: case_85
; Generated at: 2025-10-19T07:32:34.077369
;
...
(declare-const violate_148_1_flag Bool)
...
(assert (= violate_148_1 violate_148_1_flag))
...
(assert (= violate_148_3_1
   (or (not internal_audit_executed)
...
; [insurance:internal_control_comprehensive] 內部控制及稽核制度涵蓋各項必要作業程序
...
(assert (= violate_148_1_flag false))
