...
; Case ID: case_296
; Generated at: 2025-10-19T12:20:55.587157
;
...
; [bank:internal_derivative_operation_ok] 衍生性金融商品業務內部作業制度及程序建立且確實執行
...
; [bank:violation_internal_systems] 未依規定建立或執行內部控制、內部處理、內部作業或衍生性金融商品內部作業制度
...
; [meta:penalty_conditions] 處罰條件：未依規定建立或執行內部制度時處罰
(assert (= penalty violation_internal_systems))
...
(assert (= internal_derivative_operation_established true))
(assert (= internal_derivative_operation_executed true))
(assert (= penalty true))
