...
; Case ID: case_164
; Generated at: 2025-10-19T09:41:00.384624
;
...
; [bank:derivative_operation_established] 衍生性金融商品業務內部作業制度及程序建立
...
; [meta:penalty_conditions] 處罰條件：未依規定建立或執行內部控制、內部處理、內部作業或衍生性金融商品業務內部作業制度及程序時處罰
(assert (= penalty
...
(assert (= derivative_operation_ok false))
