...
; Case ID: case_384
; Generated at: 2025-10-19T14:34:08.772685
;
...
(declare-const explanation_document_false Bool)
(declare-const explanation_document_not_according_to_rules Bool)
(declare-const internal_control_established Bool)
(declare-const internal_control_executed Bool)
(declare-const internal_handling_established Bool)
(declare-const internal_handling_executed Bool)
(declare-const not_proactively_disclose Bool)
(declare-const not_provide_explanation_document Bool)
...
(assert (= violate_148_2_1
   (or not_provide_explanation_document
       explanation_document_false
       explanation_document_not_according_to_rules)))

; [insurance:violate_148_2_2] 違反第一百四十八條之二第二項規定：未依限向主管機關報告或主動公開說明，或向主管機關報告或公開說明之內容不實
(assert (= violate_148_2_2
   (or not_proactively_disclose
...
(assert (= not_provide_explanation_document false))
(assert (= explanation_document_not_according_to_rules false))
(assert (= explanation_document_false false))
