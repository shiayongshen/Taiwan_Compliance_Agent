...
; Case ID: case_219
; Generated at: 2025-10-19T10:44:20.316917
;
...
(declare-const derivative_business_operation_established_flag Bool)
(declare-const derivative_business_operation_executed Bool)
(declare-const derivative_business_operation_executed_flag Bool)
...
(assert (= derivative_business_operation_established
   derivative_business_operation_established_flag))

; [bank:derivative_business_operation_executed] 衍生性金融商品業務內部作業制度及程序確實執行
(assert (= derivative_business_operation_executed
   derivative_business_operation_executed_flag))
...
(assert (= derivative_business_operation_established_flag true))
(assert (= derivative_business_operation_executed_flag true))
(assert (= penalty true))
(assert (= derivative_business_operation_established false))
(assert (= derivative_business_operation_executed false))
(assert (= derivative_business_operation_ok false))
