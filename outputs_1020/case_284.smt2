...
; Case ID: case_284
; Generated at: 2025-10-19T12:04:57.920486
;
...
; [bank:internal_compliance] 內部控制、處理及作業制度均建立且執行
...
; [meta:penalty_conditions] 處罰條件：未依規定建立或執行內部控制、處理或作業制度時處罰
(assert (= penalty
...
(assert (= penalty true))
(assert (= internal_compliance false))
