...
; Case ID: case_253
; Generated at: 2025-10-19T11:24:45.047057
;
...
; [bank:internal_control_executed] 確實執行內部控制及稽核制度
...
; [bank:internal_handling_executed] 確實執行內部處理制度及程序
...
; [bank:internal_operation_executed] 確實執行內部作業制度及程序
...
; [bank:violation_129_7] 違反第129條第7款：未依規定建立或執行內部控制、內部處理、內部作業制度及程序
