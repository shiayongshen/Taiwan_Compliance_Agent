...
; Case ID: case_348
; Generated at: 2025-10-19T13:44:31.948783
;
...
; [bank:internal_derivative_operation_ok] 衍生性金融商品業務內部作業制度建立且確實執行
...
; [meta:penalty_conditions] 處罰條件：未依規定建立或執行內部控制、內部處理、內部作業制度或衍生性金融商品業務內部作業制度時處罰
(assert (= penalty
   (or (not internal_control_and_handling_and_operation_ok)
...
(assert (= internal_control_and_handling_and_operation_ok false))
